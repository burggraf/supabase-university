<script lang="ts">
	...
	const doneThat = async () => {
		const options = {
			header: 'Great!',
			subHeader: 'Thanks for installing Supabase University!',
...
<svelte:head>
	<title>Install Supabase University</title>
</svelte:head>

<ion-content fullscreen class="ion-padding">
	<br />
	<img src="/assets/icon-512.png" alt="Supabase University" width="55%" />
	<h2>Hey there!</h2>
	{#if !isSafari}
		<br /><br />
	...
	{#if isSafari}
		...
		<img src="/assets/safari-bar.png" alt="Safari Bar" />
		<br />
		<img width="60%" src="/assets/safari-share-options.png" alt="Safari Share Options" /><br />
